...
- **Prior verification:** `blogpost-independent-verification.md` (generated with **muse-spark-1.2**)
...
4. Prior verification (muse-spark-1.2), `blogpost-independent-verification.md`.

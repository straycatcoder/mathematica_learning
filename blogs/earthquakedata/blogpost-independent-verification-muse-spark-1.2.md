...
*Re-running Charles J. Ammon's 2017 test on Wolfram Language 15.0.1 and comparing two 2026 follow-ups (Claude's `blogpost-followup-claude-sonnet-5.md` and ChatGPT's `blogpost-followup-GPT5.6-sol.md`)*
...
- **Follow-up B (ChatGPT):** `blogpost-followup-GPT5.6-sol.md` — *"Revisiting Mathematica's earthquake data: is the magnitude problem fixed?"*
...
3. Follow-up B — ChatGPT, *Revisiting Mathematica's earthquake data...* (`blogpost-followup-GPT5.6-sol.md`), WL 15.0.1 (2026-09-04).
